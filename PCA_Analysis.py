...
dataTensor_1 = torch.empty((1, 1024), dtype=torch.float32).fill_(0)
...
for t in range(epochs):
    ...
    ##########################################################
    # Run PCA analysis on modified model weights for Layer 2 #
    ##########################################################
    m_2 = model.linear2
    ...
    ##########################################################
    # Run PCA analysis on modified model weights for Layer 3 #
    ##########################################################
    m_3 = model.linear3
    ...
    ##########################################################
    # Run PCA analysis on modified model weights for Layer 4 #
    ##########################################################
    m_4 = model.linear4
...
fig.suptitle('PCA Analysis @ Model Level')

x_1 = [x[0] for x in weight_1]
y_1 = [y[1] for y in weight_1]
ax.scatter(x_1,y_1, c='tab:blue', label='Linear Layer 1')

x_2 = [x[0] for x in weight_2]
y_2 = [y[1] for y in weight_2]
ax.scatter(x_2,y_2, c='tab:green', label='linear Layer 2')

x_3 = [x[0] for x in weight_3]
y_3 = [y[1] for y in weight_3]
ax.scatter(x_3,y_3, c='tab:red', label='Linear Layer 3')

x_4 = [x[0] for x in weight_4]
y_4 = [y[1] for y in weight_4]
ax.scatter(x_4,y_4, c='tab:orange', label='Linear Layer 4')
